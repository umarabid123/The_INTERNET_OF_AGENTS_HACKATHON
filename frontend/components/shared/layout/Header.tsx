        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link
              href="/hotel-booking"
              className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                pathname === "/hotel-booking" ? "text-primary bg-primary/10" : "text-card-foreground hover:text-primary"
              }`}
            >
              Hotels
            </Link>
            <Link
              ...
              className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                pathname === "/travel-insurance" ? "text-primary bg-primary/10" : "text-card-foreground hover:text-primary"
              }`}
            >
              Insurance
            </Link>
